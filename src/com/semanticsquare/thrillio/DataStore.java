...
public class DataStore {
    private static final int USER_BOOKMARK_COUNT = 5;
    ...
    private static void loadBooks() {
        ...
        bookmarks[2][2] = BookmarkManager.getInstance().createBook(4001, "Self-Reliance and Other Essays", 1993,"Dover Publications", new String[]{"Ralph Waldo Emerson"}, "Philosophy", 4.5);
